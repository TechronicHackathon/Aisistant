    ...
    public async Task<string> FindMostSimilarPhrase(string reference, List<String> testValues)
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            using (var response = await httpClient.PostAsJsonAsync("https://api.cohere.ai/embed", keyWordsRequest))
            {
                ...
                return calculateClosestsToReference(reference, result.Take(16).ToDictionary(pair => pair.Key, pair => pair.Value));
...
{ 
      ...
      "return_likelihoods": "NONE" 
        ...
        */
        ...
        {
            model = "xlarge",
            prompt = $"Passage: Is Wordle getting tougher to solve? Players seem to be convinced that the game has gotten harder in recent weeks ever since The New York Times bought it from developer Josh Wardle in late January. The Times has come forward and shared that this likely isn't the case. That said, the NYT did mess with the back end code a bit, removing some offensive and sexual language, as well as some obscure words There is a viral thread claiming that a confirmation bias was at play. One Twitter user went so far as to claim the game has gone to \"the dusty section of the dictionary\" to find its latest words.\n\ninteresting TLDR: Did you know that the New York times bought the game \"Wordle\"? Players think this has made it harder, but this isn't the case! The New York Times has remove some offensive content and even made it easier by removing obscure words!\n--\nPassage: ArtificialIvan, a seven-year-old, London-based payment and expense management software company, has raised $190 million in Series C funding led by ARG Global, with participation from D9 Capital Group and Boulder Capital. Earlier backers also joined the round, including Hilton Group, Roxanne Capital, Paved Roads Ventures, Brook Partners, and Plato Capital.\n\ninteresting TLDR: A startup that is only seven years old raised a whopping $190 million in funding! Wow! The funders included participation from D9 Capital Group and Boulder Capital, joining earlier backers Hilton Group, Roxanne Capital, Paved Roads Ventures, Brook Partners, and Plato Capital.\n--\nPassage: Autonomous ships that monitor the ocean, AI-driven satellite data analysis, passive acoustics or remote sensing and other applications of environmental monitoring make use of machine learning.For example, \"Global Plastic Watch\" is an AI-based satellite monitoring-platform for analysis/tracking of plastic waste sites to help prevention of plastic pollution – primarily ocean pollution – by helping identify who and where mismanages plastic waste, dumping it into oceans.\n\ninteresting TLDR: Did you realize AI is used in applications for environmental monitoring? For example, Global Plastic Watch is an AI-based satellite monitoring-platform for analysis/tracking of plastic waste sites to help prevention of plastic pollution.\n--\nPassage:{paragraph}\n\ninteresting TLDR:",
            max_tokens = 75,
            temperature = .8,
            k = 0,
            p = 1,
